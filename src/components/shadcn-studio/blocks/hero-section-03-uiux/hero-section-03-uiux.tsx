        ...
        <div className='flex max-w-2xl flex-col justify-center gap-10 pt-28 pb-12'>
          <div className='flex flex-col items-start gap-8'>
            ...
            >
              ...
              <span className='text-muted-foreground text-sm font-medium'>UI/UX Design</span>
            </MotionPreset>
            ...
            >
              Design That's Built To Ship — Not Just To Win Dribbble.
            </MotionPreset>
            ...
            >
              Pretty design is easy. Design that respects user attention, engineering reality and business goals is hard. That's what we do.
            </MotionPreset>
