        ...
        <div className='flex max-w-2xl flex-col justify-center gap-10 pt-28 pb-12'>
          <div className='flex flex-col items-start gap-8'>
            ...
            >
              ...
              <span className='text-muted-foreground text-sm font-medium'>SaaS Product Development</span>
            </MotionPreset>
            ...
            >
              We Build SaaS The Same Way We Built Our Own.
            </MotionPreset>
            ...
            >
              Multi-tenant architecture, subscription billing, role-based access, usage metering, customer onboarding — the boring infrastructure that makes the difference between an app and a product. We've done it for AI Greentick. We can do it for yours.
            </MotionPreset>
