...
const CTA = () => {
  const services = ['RAG Architectures', 'Vision LLMs', 'Cost Optimization', 'Private Deployments']
        ...
        <div className='space-y-8 text-center'>
          <div className='space-y-4'>
            <MotionPreset fade slide={{ direction: 'down', offset: 50 }} transition={{ duration: 0.7 }}>
              <h2 className='text-2xl font-semibold md:text-3xl lg:text-4xl'>Have an AI idea you're not sure will work?</h2>
            </MotionPreset>
            <MotionPreset fade slide={{ direction: 'down', offset: 50 }} delay={0.2} transition={{ duration: 0.7 }}>
              <p className='text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto'>
                We'll tell you honestly — sometimes it will, sometimes it won't, sometimes there's a smaller experiment that proves it first.
              </p>
            </MotionPreset>
          </div>
          ...
          <MotionPreset fade slide={{ direction: 'down', offset: 30 }} delay={0.6} transition={{ duration: 0.7 }}>
            <div className='flex flex-wrap items-center justify-center gap-4'>
              <PrimaryGrowButton size='lg' className='gap-2'>
                Book an AI Strategy Call <LogoVector className='size-6' />
              </PrimaryGrowButton>
