      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-12 space-y-4 text-center sm:mb-16 lg:mb-24'>
          ...
          <p className='text-muted-foreground text-xl'>
            AI Greentick is your all-in-one suite for building and launching a thriving WhatsApp marketing and support engine.
          </p>
        </div>
          ...
          <div className='flex items-start gap-4'>
            ...
            <div>
              ...
              <p className='text-muted-foreground text-lg'>
                AI Greentick provides all the essential tools and resources needed to scale your WhatsApp channel efficiently.
              </p>
            </div>
          </div>
