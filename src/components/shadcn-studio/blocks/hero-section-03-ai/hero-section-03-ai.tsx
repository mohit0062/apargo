        ...
        <div className='flex max-w-2xl flex-col justify-center gap-10 pt-28 pb-12'>
          <div className='flex flex-col items-start gap-8'>
            ...
            >
              ...
              <span className='text-muted-foreground text-sm font-medium'>AI & Machine Learning</span>
            </MotionPreset>
            ...
            >
              Practical AI — The Kind That Earns Its Monthly Bill.
            </MotionPreset>
            ...
            >
              We use LLMs and ML where they replace real hours, real headcount or real customer wait time. We skip them where they don't. No AI theatre — just systems that move metrics.
            </MotionPreset>
