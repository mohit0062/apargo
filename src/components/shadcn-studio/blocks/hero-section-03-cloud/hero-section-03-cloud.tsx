        ...
        <div className='flex max-w-2xl flex-col justify-center gap-10 pt-28 pb-12'>
          <div className='flex flex-col items-start gap-8'>
            ...
            >
              ...
              <span className='text-muted-foreground text-sm font-medium'>Cloud & DevOps</span>
            </MotionPreset>
            ...
            >
              Cloud Bills You Can Read. Uptime You Don't Have To Babysit.
            </MotionPreset>
            ...
            >
              We run our own SaaS on the same setup we'll build for you. AWS, GCP, Azure — production-grade, observable, automated, with on-call coverage when you need it.
            </MotionPreset>
