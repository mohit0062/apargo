...
const CTA = () => {
  const services = ['Multi-tenant Isolation', 'Stripe Billing', 'Role-based Access', 'Usage Metering']
        ...
        <div className='space-y-8 text-center'>
          <div className='space-y-4'>
            <MotionPreset fade slide={{ direction: 'down', offset: 50 }} transition={{ duration: 0.7 }}>
              <h2 className='text-2xl font-semibold md:text-3xl lg:text-4xl'>Got a SaaS idea that needs builders?</h2>
            </MotionPreset>
            <MotionPreset fade slide={{ direction: 'down', offset: 50 }} delay={0.2} transition={{ duration: 0.7 }}>
              <p className='text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto'>
                Let's discuss architecture, multi-tenancy, and how to get your product in front of paying users.
              </p>
            </MotionPreset>
          </div>
          ...
          <MotionPreset fade slide={{ direction: 'down', offset: 30 }} delay={0.6} transition={{ duration: 0.7 }}>
            <div className='flex flex-wrap items-center justify-center gap-4'>
              <PrimaryGrowButton size='lg' className='gap-2'>
                Book a SaaS Strategy Call <LogoVector className='size-6' />
              </PrimaryGrowButton>
