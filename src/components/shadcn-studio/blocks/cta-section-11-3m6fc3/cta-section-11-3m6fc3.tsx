...
const CTA = () => {
  const services = ['WhatsApp Broadcasts', 'Shared Inbox', 'AI Chatbots', 'Campaign Analytics']
        ...
        <div className='space-y-8 text-center'>
          <div className='space-y-4'>
            <MotionPreset fade slide={{ direction: 'down', offset: 50 }} transition={{ duration: 0.7 }}>
              <h2 className='text-2xl font-semibold md:text-3xl lg:text-4xl'>Try AI Greentick on your own WhatsApp number.</h2>
            </MotionPreset>
