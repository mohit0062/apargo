      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-12 space-y-4 text-center sm:mb-16 lg:mb-24'>
          ...
          <MotionPreset
            ...
            transition={{ duration: 0.5 }}
          >
            We look at your current bill, identify the top 5 things eating money, and fix them. Many clients see 30 to 50 percent savings in the first quarter.
          </MotionPreset>
        </div>
        ...
        <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3'>
          ...
          <MotionPreset fade blur transition={{ duration: 0.8 }} delay={1.4} className='h-full'>
            <Card className='border-primary/40 hover:border-primary bg-primary/5 hover:bg-primary/10 flex h-full flex-col justify-between p-6 shadow-none hover:shadow-lg hover:shadow-primary/10 transition-all duration-300'>
              <div>
                <h6 className='mb-2 text-lg font-semibold text-primary'>Book a Free Cloud Audit</h6>
                <p className='text-muted-foreground text-base leading-7'>
                  Get a comprehensive punch list of immediate infrastructure savings.
                </p>
              </div>
