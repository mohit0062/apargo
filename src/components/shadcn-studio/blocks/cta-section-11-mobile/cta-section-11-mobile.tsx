...
const CTA = () => {
  const services = ['iOS & Android', 'React Native & Flutter', 'Native Swift & Kotlin', 'Offline-First Architecture']
        ...
        <div className='space-y-8 text-center'>
          <div className='space-y-4'>
            <MotionPreset fade slide={{ direction: 'down', offset: 50 }} transition={{ duration: 0.7 }}>
              <h2 className='text-2xl font-semibold md:text-3xl lg:text-4xl'>Ready to ship your app?</h2>
            </MotionPreset>
          ...
          <MotionPreset fade slide={{ direction: 'down', offset: 30 }} delay={0.6} transition={{ duration: 0.7 }}>
            <div className='flex flex-wrap items-center justify-center gap-4'>
              <PrimaryGrowButton size='lg' className='gap-2'>
                Talk to a Mobile Engineer <LogoVector className='size-6' />
              </PrimaryGrowButton>
