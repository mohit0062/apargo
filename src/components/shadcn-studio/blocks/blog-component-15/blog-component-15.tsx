            ...
            <div className='flex items-center justify-between'>
              ...
              <a
                ...
                className={cn(
                  ...
                  'group-hover:bg-primary! group-hover:text-primary-foreground group-hover:border-primary hover:border-primary hover:bg-primary! hover:text-primary-foreground'
                )}
              >
...
const Blog = ({ blogPosts }: BlogProps) => {
  const categories = ['All', 'Engineering', 'AI & Automation', 'SaaS Playbook', 'Product Design', 'Startup Growth', 'Design Systems', 'Analytics']
      ...
      <div className='mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:space-y-16 lg:px-8'>
        ...
        <Tabs defaultValue='All' className='gap-8 lg:gap-16'>
          <div className='flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center'>
            <div className='bg-muted w-full overflow-x-auto rounded-lg sm:w-auto'>
