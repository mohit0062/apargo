...
const CTA = () => {
  const services = ['100% IP ownership', 'No per-seat tax', 'Tally & SAP Integrations', 'Bespoke Workflows']
        ...
        <div className='space-y-8 text-center'>
          <div className='space-y-4'>
            <MotionPreset fade slide={{ direction: 'down', offset: 50 }} transition={{ duration: 0.7 }}>
              <h2 className='text-2xl font-semibold md:text-3xl lg:text-4xl'>Spreadsheets cracking under load?</h2>
            </MotionPreset>
            <MotionPreset fade slide={{ direction: 'down', offset: 50 }} delay={0.2} transition={{ duration: 0.7 }}>
              <p className='text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto'>
                Stop duct-taping three different SaaS subscriptions together. Let's design a custom platform built around how your team actually works.
              </p>
            </MotionPreset>
          </div>
          ...
          <MotionPreset fade slide={{ direction: 'down', offset: 30 }} delay={0.6} transition={{ duration: 0.7 }}>
            <div className='flex flex-wrap items-center justify-center gap-4'>
              <PrimaryGrowButton size='lg' className='gap-2'>
                Book a Custom Software Call <LogoVector className='size-6' />
              </PrimaryGrowButton>
