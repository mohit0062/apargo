    ...
    <section className='py-8 sm:py-16 lg:py-24'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-12 space-y-4 sm:mb-16 lg:mb-24'>
          <h2 className='text-2xl font-semibold md:text-3xl lg:text-4xl'>Design services</h2>
          <p className='text-muted-foreground text-xl'>
            Product, mobile and dashboard UX design by Apargo. Design systems, prototypes and shipped product UI.
          </p>
        </div>
        ...
        <div className='grid gap-6 grid-cols-1 md:grid-cols-6'>
          {featuresList.map((features, index) => (
            <Card
              key={index}
              className={cn(
                'shadow-none hover:shadow-lg hover:shadow-primary/10 transition-all duration-300',
