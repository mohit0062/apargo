...
const CTA = () => {
  const services = ['Web Development', 'Mobile Apps', 'Custom Software', 'AI & Automation']
        ...
        <div className='space-y-8 text-center'>
          <div className='space-y-4'>
            ...
            <MotionPreset fade slide={{ direction: 'down', offset: 50 }} delay={0.2} transition={{ duration: 0.7 }}>
              <p className='text-muted-foreground text-lg md:text-xl'>
                Tell us what you're building. We'll reply within one working day with honest feedback <br /> and a clear next step, even if it's not us.
              </p>
            </MotionPreset>
          </div>
          ...
          <MotionPreset fade slide={{ direction: 'down', offset: 30 }} delay={0.6} transition={{ duration: 0.7 }}>
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <a href="mailto:hello@apargo.com" className="px-6 py-3 border border-border rounded-lg font-medium hover:bg-muted transition-colors">
