        ...
        <div className='flex max-w-2xl flex-col justify-center gap-10 pt-28 pb-12'>
          <div className='flex flex-col items-start gap-8'>
            ...
            >
              ...
              <span className='text-muted-foreground text-sm font-medium'>AI Greentick</span>
            </MotionPreset>
            ...
            >
              AI Greentick — Turn WhatsApp Into a Serious Growth Channel.
            </MotionPreset>
            ...
            >
              High-deliverability broadcasts, shared team inbox, AI chatbots and full campaign analytics — all on the official WhatsApp Business API. Built and operated by Apargo, used by businesses across India and beyond.
            </MotionPreset>
            ...
            >
              <Button size='lg' render={<a href='https://aigreentick.com' />}>
                Visit aigreentick.com
              </Button>
              <Button size='lg' className='bg-primary/10 hover:bg-primary/20 text-primary' render={<a href='/contact?intent=demo' />}>
                Book a Demo
              </Button>
            </MotionPreset>
          </div>
