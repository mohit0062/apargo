        ...
        <div className='mb-12 space-y-4 text-center sm:mb-16 lg:mb-24'>
          ...
          <MotionPreset fade slide={{ direction: 'up', offset: 50 }} blur delay={0.4} transition={{ duration: 0.5 }}>
            <p className='text-muted-foreground text-xl max-w-3xl mx-auto'>
              We use modern design and handoff tooling to ensure your designers and engineers stay perfectly in sync.
            </p>
          </MotionPreset>
        </div>

        <MotionPreset fade blur delay={0.6} transition={{ duration: 0.5 }}>
          <Card className='bg-card overflow-hidden shadow-none border hover:shadow-lg hover:shadow-primary/10 transition-all duration-300'>
