    ...
    <section className='bg-muted py-8 sm:py-16 lg:py-24'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-12 space-y-4 text-center sm:mb-16 lg:mb-24'>
          ...
          >
            Infrastructure we build into every SaaS
          </MotionPreset>
          ...
          <MotionPreset
            ...
            transition={{ duration: 0.5 }}
          >
            The foundational architecture that turns a basic web application into an enterprise-grade SaaS product.
          </MotionPreset>
        </div>
        ...
        <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4'>
          ...
          <MotionPreset fade blur transition={{ duration: 0.8 }} delay={1.4} className='h-full'>
            <Card className='border-primary/40 hover:border-primary bg-primary/5 hover:bg-primary/10 flex h-full flex-col justify-between p-6 shadow-none transition-colors duration-300'>
              <div>
                <h6 className='mb-2 text-lg font-semibold text-primary'>Start Your SaaS</h6>
                <p className='text-muted-foreground text-base leading-7'>
                  Book a consultation to discuss your multi-tenant SaaS architecture.
                </p>
              </div>
