      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-12 space-y-4 text-center sm:mb-16 lg:mb-24'>
          ...
          <MotionPreset
            ...
            transition={{ duration: 0.5 }}
          >
            Our design process is tightly coupled with engineering reality. No silos, no unbuildable mockups.
          </MotionPreset>
        </div>
        ...
        <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
          ...
          <MotionPreset fade blur transition={{ duration: 0.8 }} delay={1.4} className='h-full'>
            <Card className='border-primary/40 hover:border-primary bg-primary/5 hover:bg-primary/10 flex h-full flex-col justify-between p-6 shadow-none hover:shadow-lg hover:shadow-primary/10 transition-all duration-300'>
              <div>
                <h6 className='mb-2 text-lg font-semibold text-primary'>Start a Design Project</h6>
                <p className='text-muted-foreground text-base leading-7'>
                  Book a consultation to align your product UX with engineering reality.
                </p>
              </div>
