        ...
        <div className='flex max-w-2xl flex-col justify-center gap-10 pt-28 pb-12'>
          <div className='flex flex-col items-start gap-8'>
            ...
            >
              ...
              <span className='text-muted-foreground text-sm font-medium'>Digital Marketing & SEO</span>
            </MotionPreset>
            ...
            >
              Shipping Is Half The Job. Getting Found Is The Other Half.
            </MotionPreset>
            ...
            >
              We help SaaS, tech and product companies show up where their buyers search — Google, AI search engines, paid channels and inside their own product. Built by engineers who treat marketing the way they treat code.
            </MotionPreset>
