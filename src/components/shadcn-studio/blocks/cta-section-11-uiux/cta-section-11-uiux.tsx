...
const CTA = () => {
  const services = ['SaaS Dashboards', 'Mobile UX', 'Design Systems', 'UX Audits']
        ...
        <div className='space-y-8 text-center'>
          <div className='space-y-4'>
            <MotionPreset fade slide={{ direction: 'down', offset: 50 }} transition={{ duration: 0.7 }}>
              <h2 className='text-2xl font-semibold md:text-3xl lg:text-4xl'>Design that ships or design that wins awards?</h2>
            </MotionPreset>
            <MotionPreset fade slide={{ direction: 'down', offset: 50 }} delay={0.2} transition={{ duration: 0.7 }}>
              <p className='text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto'>
                We're in the first camp. Want to talk?
              </p>
            </MotionPreset>
          </div>
          ...
          <MotionPreset fade slide={{ direction: 'down', offset: 30 }} delay={0.6} transition={{ duration: 0.7 }}>
            <div className='flex flex-wrap items-center justify-center gap-4'>
              <PrimaryGrowButton size='lg' className='gap-2'>
                Book a Design Call <LogoVector className='size-6' />
              </PrimaryGrowButton>
